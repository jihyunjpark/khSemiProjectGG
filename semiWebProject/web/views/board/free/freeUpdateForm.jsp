...
<%@include file="/views/common/header.jsp" %>
	<div class="outer">
		<div class="tableArea" align="center">
			<form method="post" action="/swp/updateFree.do">
			<input type="hidden" name="userid" value="<%=member.getUserId() %>"/>
			<input type="hidden" name="bno" value="<%=free.getBoard_no()%>"/>
				<table>
					<tr>
						<th>제목</th>
						<td><input type="text" id="title" name="title" size="30" value="<%=free.getTitle()%>"></td>
					</tr>
					<tr>
						<td colspan="2"><textarea id="content" name="content" cols="40" rows="15"><%=free.getBoard_content() %></textarea></td>
					</tr>
				</table>
				<div align="center">
