...
<%@page import="report.review.model.vo.ReportVo"%>
...
<div class="outer">
	<h1 align="center">리뷰 신고 목록</h1>
	
	<div class="tableArea">
		<table align="center">
			<tr >
				<th width="100">공연번호</th>
				<th width="50">번호</th>
				<th width="100">작성자</th>
				<th width="300">내용</th>
				<th width="150">작성일</th>
...
$(function(){
	$(".tableArea td").mouseenter(function(){
		...
		location.href = "/swp/selectReport.do?boardNo=" + boardNo + "&currentPage=" + <%=currentPage%>; 		
	});
});
function movePage(pageNum){
	location.href = "/swp/reportList.do?currentPage=" + pageNum;
}
