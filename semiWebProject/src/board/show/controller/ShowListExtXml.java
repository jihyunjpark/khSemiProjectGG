...
public class ShowListExtXml {
	...
	public List<ShowVo2> getXmlDataSAX(int page, String type) {
		...
		try {
			String baseUrl = "http://www.kopis.or.kr/openApi/restful/pblprfr?service=d11d486f591e447d84737299b2895c19&stdate=20180101&eddate=20181231&cpage=" + page + "&rows=12&prfstate=01&prfstate=02&shcate=" + type;
	...
	public List<ShowVo2> getSearchShow(int page, String word) {
		List<ShowVo2> showList = null;
		
		try {
			String baseUrl = "http://kopis.or.kr/openApi/restful/pblprfr?service=d11d486f591e447d84737299b2895c19&stdate=20180101&eddate=20181231&cpage=" + page + "&rows=12&shprfnm=" + word;
			SAXBuilder builder = new SAXBuilder();
			Document doc = (Document) builder.build(new java.net.URL(baseUrl));
			Element root = doc.getRootElement(); // result
