...
public class XmlExtractionSAX {

	public List<TheaterVo> getXmlDataSAX() {
		List<TheaterVo> theaterList = null;
		
		try {
			String baseUrl = "http://www.kopis.or.kr/openApi/restful/prfplc?service=d11d486f591e447d84737299b2895c19&cpage=1&rows=5&shprfnmfct=예술의전당";
