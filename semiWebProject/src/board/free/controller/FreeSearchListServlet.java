...
@WebServlet("/searchFreeList.do")
public class FreeSearchListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public FreeSearchListServlet() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//게시글의 총 갯수
		int listCount = bs.selectSearchFreeTotalCount(condition, keyword);
		//134 -> 14
		...
		//페이지 처리 후 게시글 조회
		List<FreeVo> list = bs.selectSearchFreeList(currentPage, limit, condition, keyword);
